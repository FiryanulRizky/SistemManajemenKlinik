...
<html>
  <head>
    ...
    <title>SMKlinik | Data Apoteker</title>
  </head>
  <body>
    <header>
      <div class="container">
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="button">
          <a href="add-apoteker.php"><button type="button" name="tambah">Tambah</button></a>
          ...
          <table border=1px>
            ...
            <?php
              include('connect.php');
							...
							if (isset($cari)) {
								if ($inputan != "") {
									$sql = mysqli_query($connect,"SELECT * FROM tb_apoteker WHERE nama like '%$inputan%'");
								}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_apoteker");
								}
							}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_apoteker");
							}
              ...
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $data['id_apoteker']; ?></td>
                ...
                <td>
                  <a class="edit" href="update-apoteker.php?id=<?php echo $data['id_apoteker'] ?>">Edit</a> |
                  <a class="hapus" href="delete-apoteker.php?id=<?php echo $data['id_apoteker'] ?>">Hapus</a>
                </td>
              </tr>
            <?php  }
             ?>
