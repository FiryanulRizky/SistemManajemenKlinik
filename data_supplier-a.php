...
<html>
  <head>
    ...
    <title>SMKlinik | Data Supplier</title>
  </head>
  <body>
    <header>
      <div class="container">
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="button">
          <a href="add-supplier.php"><button type="button" name="tambah">Tambah</button></a>
          ...
          <table border=1px>
            ...
            <?php
              include('connect.php');
							...
							if (isset($cari)) {
								if ($inputan != "") {
									$sql = mysqli_query($connect,"SELECT * FROM tb_supplier WHERE nama like '%$inputan%'");
								}else{
              ...
              <tr>
                ...
                <td>
                  <a class="edit" href="update-supplier.php?id=<?php echo $data['id_supplier'] ?>">Edit</a> |
                  <a class="hapus" href="delete-supplier.php?id=<?php echo $data['id_supplier'] ?>">Hapus</a>
                </td>
              </tr>
            <?php  }
             ?>
