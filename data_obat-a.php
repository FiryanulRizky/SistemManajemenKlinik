...
<html>
  <head>
    ...
    <title>SMKlinik | Data Obat</title>
  </head>
  <body>
    <header>
      <div class="container">
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="button">
          <a href="add-obat.php"><button type="button" name="tambah">Tambah</button></a>
          ...
          <table border=1px>
            ...
            <?php
              include('connect.php');
							...
							if (isset($cari)) {
								if ($inputan != "") {
									$sql = mysqli_query($connect,"SELECT * FROM tb_obat WHERE nama like '%$inputan%'");
								}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_obat");
								}
							}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_obat");
							}
              ...
              <tr>
                ...
                <td>
                  <a class="edit" href="update-obat.php?id=<?php echo $data['no_obat'] ?>">Edit</a> |
                  <a class="hapus" href="delete-obat.php?id=<?php echo $data['no_obat'] ?>">Hapus</a>
                </td>
              </tr>
            <?php  }
             ?>
