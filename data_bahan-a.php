...
<html>
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="./css/data-b_style.css">
    <title>SMKlinik | Data Bahan</title>
  </head>
  <body>
    <header>
      <div class="container">
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="button">
          <a href="add-bahan.php"><button type="button" name="tambah">Tambah</button></a>
          ...
          <table border=1px>
            ...
            <?php
              include('connect.php');
							...
							if (isset($cari)) {
								if ($inputan != "") {
									$sql = mysqli_query($connect,"SELECT * FROM tb_bahan WHERE nama like '%$inputan%'");
								}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_bahan");
								}
							}else{
									$sql = mysqli_query($connect,"SELECT * FROM tb_bahan");
							}
              ...
              <tr>
                ...
                <td>
                  <a class="edit" href="update-bahan.php?id=<?php echo $data['no_bahan'] ?>">Edit</a> |
                  <a class="hapus" href="delete-bahan.php?id=<?php echo $data['no_bahan'] ?>">Hapus</a>
                </td>
              </tr>
            <?php  }
             ?>
